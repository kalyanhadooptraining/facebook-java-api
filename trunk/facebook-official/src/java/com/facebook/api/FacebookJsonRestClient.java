...
/**
 * A FacebookRestClient that uses the JSON result format. This means results from calls to the
 * Facebook API are returned as <a href="http://www.json.org/">JSON</a> and transformed into Java
 * <code>Object</code>'s.
 */
public class FacebookJsonRestClient extends ExtensibleClient<Object> {
    ...
    /**
     * Extracts a URL from a result that consists of a URL only. For JSON, that result is simply a
     * String.
     * 
     * @param url
     * @return the URL
