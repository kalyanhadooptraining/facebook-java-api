...
public enum ApplicationProperty {    
    ...
    /**
     * Gets the name by which Facebook refers to this property.  The name is what is sent in API calls 
     * and other requests to Facebook to specify the desired property.
     * 
