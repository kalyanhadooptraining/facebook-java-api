...
/**
 * Uses preferences 161 and 162 (overwrites them) to test the data preferences
 * functions.
 * 
...
public class DataPreferencesAPITest {
	...
	private static final String illegal129Chars =
	...
	public void testDataPreferencesXML() throws Exception {
		 ...
		 * <preference><pref_id>161</pref_id><value>Pink</value></preference>
		 * <preference><pref_id>162</pref_id><value>Black</value></preference>
		 * </data_getUserPreferences_response>
		 */

		assertEquals("Pink", xpath.evaluate(
				"//fbapi:preference[fbapi:pref_id=161]/fbapi:value", pinkBlack));
		assertEquals("Black", xpath.evaluate(
				"//fbapi:preference[fbapi:pref_id=162]/fbapi:value", pinkBlack));
	}
	...
	private <T> T testCycle(IFacebookRestClient<T> client) throws Exception {
		try {
			...
			fail("Maximum size of preference string is 127. "
					+ "Trying to set a larger value should result in an error.");
