...
/**
 * This class enumerates the various metrics that are available through the admin.getDailyMetrics 
 * API call.  Typically, you will pass a set containing the metrics you are interested in to 
 * the API call.
 * 
...
public enum Metric {
     ...
     * 
     * @param name the Facebook-supplied name of the metric to lookup, such as "daily_active_users".
     * 
     ...
     * 
     * @param errorCode the code to get the metric for, such as 500, 404, 401, 200, etc..
     * 
