...
public class FacebookApiException {
     ...
     * 
     */
    public synchronized void setErrorCode(int value) {
     ...
     *     
     */
    public synchronized void setErrorMsg(String value) {
        this.errorMsg = value;
    }
     ...
     *     
     */
    public synchronized FacebookApiException.RequestArgs getRequestArgs() {
        return requestArgs;
    }
     ...
     *     
     */
    public synchronized void setRequestArgs(FacebookApiException.RequestArgs value) {
    ...
    public static class RequestArgs {
         ...
         * 
         */
        public synchronized List<Arg> getArg() {
            if (arg == null) {
