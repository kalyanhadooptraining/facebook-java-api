...
/**
 * A simple data structure for storing a story-template used 
 * in the feed_registerTemplateBundle API call.
 * 
 * @author aroth
 */
public class BundleStoryTemplate {
     ...
     * @param body the body content for this template.
     */
    ...
    /**
     * @return a JSON-encoded String representation of this template.  The resulting String is appropriate for passing 
     *         to the Facebook API server.
     */
