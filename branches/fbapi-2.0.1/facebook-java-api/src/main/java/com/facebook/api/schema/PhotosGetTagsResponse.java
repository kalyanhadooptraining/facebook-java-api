...
@XmlRootElement(name = "photos_getTags_response")
public class PhotosGetTagsResponse {
     ...
     * This is why there is not a <CODE>set</CODE> method for the photoTag property.
     * 
     * <p>
     ...
     * 
     */
    public synchronized List<PhotoTag> getPhotoTag() {
        if (photoTag == null) {
            photoTag = new ArrayList<PhotoTag>();
        }
