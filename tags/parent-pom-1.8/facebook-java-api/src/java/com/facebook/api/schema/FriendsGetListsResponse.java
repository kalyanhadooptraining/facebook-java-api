 ...
 *         &lt;element name="friendlist" type="{http://api.facebook.com/1.0/}friendlist" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "friends_getLists_response")
public class FriendsGetListsResponse {

    protected List<Friendlist> friendlist;
    @XmlAttribute
